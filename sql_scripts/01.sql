...
INSERT INTO alternative(id,name,description,commit_id) VALUES(1,'Base','Base alternative',1);
CREATE TABLE "commit" (
	id INTEGER NOT NULL, 
...
INSERT INTO "commit"(id,comment,date,user) VALUES(1,'Create the database','2023-07-25 08:59:14','spinedb_api');
CREATE TABLE entity (
	id INTEGER NOT NULL, 
	type_id INTEGER, 
	class_id INTEGER, 
...
INSERT INTO entity_class_type(id,name,commit_id) VALUES(1,'object',1);
INSERT INTO entity_class_type(id,name,commit_id) VALUES(2,'relationship',1);
...
INSERT INTO entity_type(id,name,commit_id) VALUES(1,'object',1);
INSERT INTO entity_type(id,name,commit_id) VALUES(2,'relationship',1);
